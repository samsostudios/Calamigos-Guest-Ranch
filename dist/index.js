...
(() => {
          ...
          filters.forEach((filter) => {
            filter.addEventListener("click", () => {
              if (filter === otherFilter) {
                if (otherInput) gsapWithCSS.set(otherInput, { display: "block" });
              } else {
                if (otherInput) gsapWithCSS.set(otherInput, { display: "none" });
              }
            });
          });
        }
  ...
  var FormHandler = class {
    ...
    resetFormStatus() {
      gsapWithCSS.to([this.successElement, this.errorElement], { display: "none" });
    }
  };
  var formHandler = () => {
    new FormHandler();
